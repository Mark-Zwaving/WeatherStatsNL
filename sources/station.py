...
# TODO
class Place:
    '''Class defines a weatherstation'''
    wmo      = ''
    place    = ''
    province = ''
    country  = ''
    ...
    def __init__(self, wmo, url):
        file_etmgeg_zip = fn.mk_path(c.dir_data, f'etmgeg_{wmo}.zip')
        file_etmgeg_txt = fn.mk_path(c.dir_data, f'etmgeg_{wmo}.txt')
        url_etmgeg = url
...
class KNMI:
    ...
    def __init__(self, wmo = '', plaats = '', provincie = '', info = ''):
        ...
        self.file_etmgeg_zip = fn.mk_path(c.dir_data, f'etmgeg_{self.wmo}.zip')
        self.file_etmgeg_txt = fn.mk_path(c.dir_data, f'etmgeg_{self.wmo}.txt')
        ...
        self.notification = 'BRON: KONINKLIJK NEDERLANDS METEOROLOGISCH INSTITUUT (KNMI)'
        self.empthy = '     '
        self.skip_lines = 49
