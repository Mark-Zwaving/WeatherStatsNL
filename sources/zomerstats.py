import config as cfg, fn, fn_html as h, stats as st, datum, write as wr, ask
#--------------------------------------------------------------------------------
class Warmte_getal:
...
#--------------------------------------------------------------------------------
def alg_zomerstats(lijst_stations, datum_start, datum_eind, type):
