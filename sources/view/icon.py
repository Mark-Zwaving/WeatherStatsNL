...
def i(icon='', color='', extra='', size=''):
    return f'<i class="{color} {extra} {icon} {size}"></i>'
...
def gte(color='', extra='', size=''): return i('fas fa-greater-than-equal', color, extra, size)
def gt(color='', extra='', size=''): return i('fas fa-greater-than', color, extra, size)
def lte(color='', extra='', size=''): return i('fas fa-less-than-equal', color, extra, size)
