...
let col_titles = {
    ...
    IJNSEN:    obj( 'IJNSEN',   sort_num,  ascending,   row_nr,   6 ),
    TX_MIN:    obj( 'TX_MIN',   sort_num,  ascending,   row_nr,   7 ),
    TG_MIN:	   obj( 'TG_MIN',   sort_num,  ascending,   row_nr,   8 ),
    TN_MIN:    obj( 'TN_MIN',   sort_num,  ascending,   row_nr,   9 ),
    SUN:       obj( 'SUN',      sort_num,  ascending,   row_nr,  10 ),
    RAIN:      obj( 'RAIN',     sort_num,  ascending,   row_nr,  11 ),
    TXlt0:     obj( 'TXlt0',    sort_num,  descending,  row_nr,  12 ),
    TGlt0:     obj( 'TGlt0',    sort_num,  descending,  row_nr,  13 ),
    TNlt0:     obj( 'TNlt0',    sort_num,  descending,  row_nr,  14 ),
    TNlt_5:    obj( 'TNlt_5',   sort_num,  descending,  row_nr,  15 ),
    TNlt_10:   obj( 'TNlt_10',  sort_num,  descending,  row_nr,  16 ),
    TNlt_15:   obj( 'TNlt_15',  sort_num,  descending,  row_nr,  17 ),
    TNlt_20:   obj( 'TNlt_20',  sort_num,  descending,  row_nr,  18 )
}
