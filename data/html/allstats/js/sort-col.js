...
let table_tbody      =  'table#stats>tbody',
    ...
    enti = {
        ...
        TX_MAX:    obj( 'TX_MAX',   sort_num,  ascending,   row_nr,   5 ),
        TG_MAX:	   obj( 'TG_MAX',   sort_num,  ascending,   row_nr,   6 ),
        TN_MAX:    obj( 'TN_MAX',   sort_num,  ascending,   row_nr,   7 ),
        ...
        HEATNDX:   obj( 'HEATNDX',  sort_num,  ascending,   row_nr,  13 ),
        TXGE20:    obj( 'TXGE20',   sort_num,  ascending,   row_nr,  14 ),
        TXGE25:    obj( 'TXGE25',   sort_num,  ascending,   row_nr,  15 ),
        TXGE30:    obj( 'TXGE30',   sort_num,  ascending,   row_nr,  16 ),
        TXGE35:    obj( 'TXGE35',   sort_num,  ascending,   row_nr,  17 ),
        TXGE40:    obj( 'TXGE40',   sort_num,  ascending,   row_nr,  18 ),
        TGGE18:    obj( 'TGGE18',   sort_num,  ascending,   row_nr,  19 ),
        TGGE20:    obj( 'TGGE20',   sort_num,  ascending,   row_nr,  20 ),
        SQGE10:    obj( 'SQGE10',   sort_num,  ascending,   row_nr,  21 ),
        RHGE10:    obj( 'TGGE20',   sort_num,  ascending,   row_nr,  22 ),

        HELLMANN:  obj( 'HELLMANN', sort_num,  ascending,   row_nr,  23 ),
        IJNSEN:    obj( 'IJNSEN',   sort_num,  ascending,   row_nr,  24 ),
        TXLT0:     obj( 'TXLT0',    sort_num,  descending,  row_nr,  25 ),
        TGLT0:     obj( 'TGLT0',    sort_num,  descending,  row_nr,  26 ),
        TNLT0:     obj( 'TNLT0',    sort_num,  descending,  row_nr,  27 ),
        TNLT_5:    obj( 'TNLT_5',   sort_num,  descending,  row_nr,  28 ),
        TNLT_10:   obj( 'TNLT_10',  sort_num,  descending,  row_nr,  29 ),
        TNLT_15:   obj( 'TNLT_15',  sort_num,  descending,  row_nr,  30 ),
        TNLT_20:   obj( 'TNLT_20',  sort_num,  descending,  row_nr,  31 )
    },
