...
def sum(lijst_geg, ent):
    ...
    return { 'value': som, 'list_all_days': l }

# Gemiddelden
def mean(lijst_geg, ent):
    ...
    return { 'value': gem, 'list_all_days': l }

# Minimum extremen
def min(lijst_geg, ent):
    ...
    return { 'value': min, 'list_all_days': l }

# Maximum extremen
def max(lijst_geg, ent):
    '''Functie bepaalt de minimum waarde van TX uit de reeks plus tijdstip mits aanwezig'''
    ...
    return { 'value': max, 'list_all_days': l }

# Counter voorwaardelijk
def cnt(lijst_geg, ent, oper, val):
    ...
    return { 'value': tel, 'list_all_days': l }

def hellmann(lijst_geg):
